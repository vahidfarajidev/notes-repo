...
-  توجه: در خصوص دریافت کاربر این کار امکان پذیر است اما در خصوص سناریوهایی مثلا دریافت جزئیات یک سفارش، بایستی از سمت مروگر، شناسه ای یا Id فرستاده شود. در این سناریوها نکته این است باید موضوع IDOR رعایت شود یعنی باید بررسی گردد آن کاربر واقعا به آن منبع مورد نظر یعنی در اینجا سفارش، دسترسی دارد یا خیر. یا به عبارنی این سفارش مربوط به این کاربر است یا خیر. مثلا ممکن است Id دیگری به سمت سرور فرستاده شود که اصلا متعلق به کاربر لاگین شده نباشد.
